...
func ErrorL(format string, args ...interface{}) {
	logging.printf(1, errorLog, format, args...)
}

func InfoL(format string, args ...interface{}) {
	logging.printf(1, infoLog, format, args...)
}
